...
public class CountriesViewStateFragment
    extends MvpLceViewStateFragment<SwipeRefreshLayout, List<StoreDTO>, CountriesView, CountriesPresenter>
  ...
  @Override public LceViewState<List<StoreDTO>, CountriesView> createViewState() {
    return new RetainingLceViewState<List<StoreDTO>, CountriesView>();
  }
  ...
  @Override public List<StoreDTO> getData() {
